...
IQTHONPC = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/979fe639e5e6b325c8c68.jpg"
...
IQPIC = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/979fe639e5e6b325c8c68.jpg"
...
async def iq(iqthonevent):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "YASEEN𓃠"
    IQTHON_IMG = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/979fe639e5e6b325c8c68.jpg"
...
‌‎⿻┊‌‎PinG 𖠄 {ping} ٫
‌‎⿻┊‌‎VeRsIoN 𖠄 (7.7) ,
‌‎⿻┊YASEEN 𖠄 @YASEEENRJDJ3"""

@iqthon.on(admin_cmd(pattern="رابط التنصيب(?: |$)(.*)"))    
async def source(e):
    await edit_or_reply(e, "https://github.com/YASEEN15/Yasee33",)
...
async def amireallyalive(event):
    ...
    IQTHON_ALIVE_TEXT = "❬ تـليثون ياسين المصري - Telethon-YASEEN ، 🕸  ❭ :"
...
async def _(event):
    ...
    OUTPUT = (f"🝳︙  وحـدة المعلومات الخاصه بتنصيبك مع جميع الفارات  لتنصيب سورس تليثون @y_a_n_u_u :**\n\n{o}")
...
async def _(event):
    ...
    await asyncio.sleep(1)
    await edit_or_reply(event , """🝳︙ جـاري تـحديث تليثـون ياسين المصري (7.7)
...
اهلن بك في سورس ياسين المصري
@y_a_n_u_u
@y_a_n_u_u
@y_a_n_u_u
@y_a_n_u_u
قناة الكلايش  : @y_a_n_u_u
قناه شروحات الاوامر  : @y_a_n_u_u
قناه المتغيرات او الفارات : @y_a_n_u_u""")
    ...
    if exe == "get":
        ...
        try:
            ...
            if variable in heroku_var:
                return await ics.edit(                    "𓆩 YASEEN_YASEEN 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"                    f"\n **⌔** `{variable} = {heroku_var[variable]}` .\n"                )
            return await ics.edit(                "𓆩 YASEEN_YASEEN 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"                f"\n **⌔ خطا :**\n-> {variable} غيـر موجود. "            )
        except IndexError:
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inlineiqthon(iqthon):
        ...
        if query.startswith("تنصيب") and iqthon.query.user_id == bot.uid:
            buttons = [[Button.url("1- شرح التنصيب", "https://t.me/YASEEENRJDJ3/2646"), Button.url("2- استخراج ايبيات", "https://my.telegram.org/"),],[Button.url("3- ستخراج تيرمكس", "https://replit.com/@telethon-Arab/generatestringsession#start.sh"), Button.url("4- بوت فاذر", "http://t.me/BotFather"),],[Button.url("5- رابط التنصيب", "http://heroku.com/deploy?template=https://github.com/YASEEN15/Yasee33"),],[Button.url("المطـور 👨🏼‍💻", "https://t.me/y_a_n_u_u"),]]
...
""" **
❨ مرحبا بك سورس تليثون ياسين المصري 🤗  ❩
———————×———————
🝳  اوامر السورس ↢ ( .م1 )
🝳  اوامر الحساب ↢ ( .م2 )
🝳  اوامر الكروب  ↢ ( .م3 )
...
( .ايقاف اسم وقتي )
———————×———————
 🝳︙ يوجد شرح مفصل عن الامر هنا : https://t.me/YASEEENRJDJ3/2646
""")
...
@check_owner
async def inlineiqthon(iqthon):
    text = "**🝳︙ قـائمـه الاوامـر :**\n**🝳︙ قنـاه السـورس :** @y_a_n_u_u\n**🝳︙ شـرح اوامـر السـورس : @y_a_n_u_u**\n**🝳︙ شـرح فـارات السـورس : @y_a_n_u_u** "
